...
/**
 Asks the data source about custom layout for custom view
 
  @param scrollView A scrollView subclass object informing the delegate.
  @return bool YES - custom layout, NO - default (centered)
*/
- (BOOL)customViewCustomLayoutForEmptyDataSet:(UIScrollView *)scrollView;
